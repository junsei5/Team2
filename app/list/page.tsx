...
const trendMap: Record<string, { title: string; slug: string; image: string }[]> = {
  "Drama": [
    {
      title: "コード・ブルー",
      slug: "code-blue",
  ...
  "Buzzword": [
    { title: "最高で金　最低でも金", slug: "dummy", image: "https://cdn.mainichi.jp/vol1/2016/01/21/20160121hpj00m050202000q/91.jpg" },
    { title: "IT革命", slug: "dummy", image: "https://th.bing.com/th/id/R.0a61fa778788a651cd3e2b59efeef2fa?rik=L%2b%2fAkzgGmdI9Rg&riu=http%3a%2f%2fwww.asahicom.jp%2fspecial%2fsengo%2fvisual%2fimages%2fvol3%2fpopular%2fit02.jpg&ehk=cyIMhzVQK6c1VF8Y%2bNIu56Z4kZfiVYiWn8Ilm6XY71o%3d&risl=&pid=ImgRaw&r=0" },
    { title: "なんでだろ～", slug: "dummy", image: "https://wanibooks.ismcdn.jp/mwimgs/7/4/750m/img_74155b0fc98b5ca25ab563e7732bcbc8482668.jpg" },
    { title: "イナバウアー", slug: "dummy", image: "https://www.sponichi.co.jp/sports/news/2019/12/05/jpeg/20191205s00079000032000p_view.jpg" },
  ],
  "CM": [
    { title: "世田谷自然食品 グルコサミン", slug: "dummy", image: "https://img.youtube.com/vi/zovyCM1571Y/hqdefault.jpg" },
    { title: "P&G 置き型ファブリーズ", slug: "dummy", image: "https://img.youtube.com/vi/K0tUUQzkgEE/hqdefault.jpg" },
    { title: "Fit's(ロッテ)", slug: "dummy", image: "https://img.youtube.com/vi/Sw2QOxnanzs/hqdefault.jpg" },
    { title: "Qoo(コカ・コーラ)", slug: "dummy", image: "https://img.youtube.com/vi/fC5ceUH0CIk/hqdefault.jpg" },
  ],
  "Fashion": [
    { title: "ローライズデニム", slug: "dummy", image: "https://th.bing.com/th/id/OIP.hlmPyum5_4-R3Fgxo_v77wHaJN?w=200&h=312&c=10&o=6&pid=genserp&rm=2&ucfimg=1" },
    { title: "キャスケット", slug: "dummy", image: "https://otokomaeken.com/wp-content/uploads/2022/08/fwwh002-2016.jpg" },
    { title: "カラータイツ", slug: "dummy", image: "https://thumbnail.image.rakuten.co.jp/@0_mall/petitcaprice/cabinet/petit01/rs-fas-386-02.jpg" },
    { title: "ロリータファッション", slug: "dummy", image: "https://tokyo-lolita-plus.blog/wp-content/uploads/2019/06/e383ade383aae383bce382bf.jpg" },
  ],
}
      ...
      <div className={styles.container}>
        ...
        <div className="px-4 pb-8">
          <div className="grid grid-cols-2 gap-4">
            {trendMap[trend].map((d) => (
              <div key={d.slug} className={`${styles.card} space-y-2 group`}>
